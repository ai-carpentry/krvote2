...
```{r, eval = TRUE}
get_elections(serviceKey = service_key)
```
...
```{r, eval = TRUE}
get_sigungu(serviceKey = service_key, sgId = "20220309")
```
...
```{r, eval = TRUE}
get_constituencies(serviceKey = service_key, sgId = "20220309", sgTypecode = "1")
```
...
```{r, eval = TRUE}
get_parties(serviceKey = service_key, sgId = "20220309")
```
...
```{r, eval = TRUE}
get_occupations(serviceKey = service_key, sgId = "20220309")
```
...
```{r, eval = TRUE}
get_education_levels(serviceKey = service_key, sgId = "20220309")
```
